...
function Features() {
  return (
    <>
      <section className="relative flex h-[550px] w-full items-center justify-center bg-[url('https://ifixandrepair.com/wp-content/themes/ifix-theme-2.0/images/banner/why_choose_us.jpg')] bg-cover bg-center bg-no-repeat p-5">
        <div className="absolute inset-0 bg-thm_root1_color bg-gradient-to-r from-cyan-600 to-indigo-950 opacity-60"></div>
        <div className="absolute inset-0 left-6 right-6 top-1/3 flex h-fit flex-col justify-center bg-gray-950 p-4 text-center text-white opacity-80 lg:left-[20%] lg:right-[20%]">
      ...
      <div className=" z-50 -mt-10 flex flex-col gap-3 px-4 md:px-12 lg:flex-row lg:gap-6">
        <div className="flex flex-col gap-3 rounded-md bg-thm_background p-5 shadow-lg lg:h-fit lg:basis-1/3">
          <svg
