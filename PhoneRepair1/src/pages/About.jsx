...
function About() {
  ...
  return (
    <div className="h-full w-full ">
      <div>
        {/* Banner start */}
        <Banner title="About us" img="https://ifixandrepair.com/wp-content/themes/ifix-theme-2.0/images/banner/about_banner.jpg" />
        {/* Banner End */}
        ...
        <div className="flex w-full flex-col p-20 px-[5%] sm:px-[12%] md:px-[8%] lg:px-[5%]  xl:px-12">
          <div className="flex w-full flex-col gap-5 md:gap-0 lg:flex-row">
            ...
            <div className="flex basis-1/2 flex-col items-start justify-start gap-2 lg:gap-5">
              ...
              {/* <div className="relative h-8 w-8">
                <div className="animate-square absolute inset-0 border border-blue-500"></div>
              </div> */}
              {/*Todo: Square animation goes here */}
          ...
          <div className="flex w-full flex-col flex-wrap gap-10 py-10 md:flex-row lg:p-20 ">
            <div className="group flex w-full items-center justify-center gap-6 md:basis-[45%]">
              <div className="flex  h-20 w-20 items-center justify-center rounded-full border-dotted border-thm_root1_color bg-thm_background  p-5 shadow-xl drop-shadow-2xl">
                <svg
                ...
                >
                  <path
                    ...
                    fill="#000"
                    className="fill-thm_secondary_color-0 bg-black group-hover:fill-thm_root1_color"
                  ></path>
                </svg>{" "}
                <div className=" absolute h-20 w-20 rounded-full border-dashed border-thm_root1_color bg-transparent animate-spin transition-all duration-1000 group-hover:border-4 "></div>
              </div>
            ...
            <div className="group flex basis-[45%] items-center gap-6">
        ...
        <div className="flex w-full flex-col flex-wrap gap-10 bg-thm_secondary_background px-[5%] py-12 sm:px-[12%] md:flex-row md:gap-5 md:px-[8%] lg:flex-nowrap lg:px-[5%]  xl:px-12">
        ...
        <div className="flex w-full flex-col flex-wrap items-center gap-3 bg-thm_background px-[5%] py-12 sm:px-[12%] md:px-[8%] lg:flex-nowrap lg:px-[5%]  xl:px-12">
          ...
          <Slider {...settings} className="team_slider slick-list  w-full py-4">
            <div
              style={myStyle}
              className="team_slide group relative max-w-sm overflow-hidden rounded shadow-lg"
            >
              <img
                className="w-full"
              ...
              />
              <div className="absolute bottom-0 w-full bg-thm_background px-6 py-4 text-center transition-all duration-500 group-hover:py-6">
                <h1>Team Leader</h1>
                <p className="text-2xl text-thm_root1_color">Andreaa Osorio</p>
              </div>
            </div>

            <div className="team_slide group relative max-w-sm overflow-hidden rounded shadow-lg">
              <img
                className="w-full"
            ...
            <div className="team_slide group relative max-w-sm overflow-hidden rounded shadow-lg">
              ...
              <div className="absolute bottom-0 w-full bg-thm_background px-6 py-4 text-center transition-all duration-500 group-hover:py-6">
                ...
                <p className="text-2xl text-thm_root1_color">
                  Daniela Marmolejo
                </p>
              </div>
            </div>
