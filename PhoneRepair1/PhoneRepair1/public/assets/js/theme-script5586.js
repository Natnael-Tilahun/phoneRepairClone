/* ------------------------------------------------
  Project:   iFixandRepair - Software Landing Page HTML5 Template
  Author:    Mario Bolanos
------------------------------------------------ */
/* ------------------------
    Table of Contents
...
/*------------------------------------
  HT Owl Carousel Accessibility Addon
--------------------------------------*/
function addDotButtonText() {
    ...
    $('.owl-dot').each(function() {
        ...
        $(this).append('<span class="offscreen" style="color:#000000; background:#ffffff;">Go to slide ' + idx + '</span>');
    });
	
	$('.owl-prev').each(function() {
        $(this).append('<span class="offscreen" style="color:#000000; background:#ffffff;">Previous slide</span>');
    });
	
	$('.owl-next').each(function() {
        $(this).append('<span class="offscreen" style="color:#000000; background:#ffffff;">Next slide</span>');
    });
}
/*------------------------------------
  HT Owl Carousel
...
function fxheader() {
  $(window).on('scroll', function () {
    if ($(window).scrollTop() >= 100 && $(window).scrollTop2() >= 100) {
...
function scrolling() {
  ...
  $('.repair-button a[href*="#"]:not([href="#"])').on('click', function() {
